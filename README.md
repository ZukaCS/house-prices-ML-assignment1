...
### 2. Ordinal Encoding 
![data_desc](images/datadesc1.webp)

- **data_description.txt**-ზე შეხედვით აქაც შევამჩნიე ერთი რამ: ზოგიერთ სვეტებს ბუნებრივი თანმიმდევრობა ჰქონდათ. მაგალითად ისეთი ცვლადები, რომლებიც ხარისხს ასახავდნენ ჰქონდათ შემდეგი კატეგორიული მნიშვნელობები: None (არ აქვს), Po (Poor), Fa (Fair), TA (Typical), Gd (Good), Ex (Excellent).
