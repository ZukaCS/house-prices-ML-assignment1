...
-- საუკეთესო მოდელი ავიღციე წრფივი მოდელებიდან. მიუხედავად იმისა, რომ მცირე განსხვავება იყო val და test-ს შორის რაც მიუთითებს მცირე overfitting-ზე, საუკეთედსო შედეგები test-ში მაინც წრფივმა მოდელებმა დადეს რეგულარიზაციით. მოდელი შევარჩიე test_rmlse -ს მიხედვით
