...
დანარჩენი რიცხვითი სვეტები კი უბრალოდ 0 ით შევავსე.
...
### 2. Ordinal Encoding 
![data_desc](images/datadesc2.webp)

- **data_description.txt**-ზე შეხედვით აქაც შევამჩნიე ერთი რამ: ზოგიერთ სვეტებს ბუნებრივი თანმიმდევრობა ჰქონდათ. მაგალითად ისეთი ცვლადები, რომლებიც ხარისხს ასახავდნენ ჰქონდათ შემდეგი კატეგორიული მნიშვნელობები: NA (არ აქვს), Po (Poor), Fa (Fair), TA (Typical), Gd (Good), Ex (Excellent).
...
![threshold_vs_removed](images/corr.webp)
