...
- data_description-ზე შეხედვით აქაც შევამჩნიე ერთი რამ: ზოგიერთ სვეტებს ბუნებრივი თანმიმდევრობა ჰქონდათ. მაგალითად ისეთი ცვლადები, რომლებიც ხარისხს ასახავდნენ ჰქონდათ შემდეგი კატეგორიული მნიშვნელობები: None (არ აქვს), Po (Poor), Fa (Fair), TA (Average), Gd (Good), Ex (Excellent).
- ასეთი სვეტებისთვის One Hot Encoding -ი უბრალოდ ზედმეტი იქნებოდა რადგან თითოეული ასეთი Feature-სთვის 6 - ცალ ახალ სვეტს დაამატებდა. ამიტომ ესეთი სვეტები ('GarageQual', 'GarageCond', 'PoolQC', 'ExterQual', 'ExterCond', 'BsmtCond', 'HeatingQC', 'KitchenQual', 'BsmtQual', 'FireplaceQu') გარდავქმენი უბრალოდ შესაბამისი რიცხვებით, რაც ხარისხს ბუნებრივად ასახავენ.
